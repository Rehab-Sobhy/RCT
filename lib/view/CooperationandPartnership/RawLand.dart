...
class Raw_Screen extends StatefulWidget {
  const Raw_Screen({super.key});

  @override
  State<Raw_Screen> createState() => _Raw_ScreenState();
}
...
class _Raw_ScreenState extends State<Raw_Screen> {
  ...
  void _validateAndSubmit(
    ...
    if (birthController.text.isEmpty && isNationalIdSelected) {
    ...
    await context.read<CooperativeCubit>().RawLandFunction(context);
  }
    ...
    return Scaffold(
      ...
      body: BlocConsumer<CooperativeCubit, Coopeativestates>(
        listener: (context, state) {
          if (state is RawLandLoadingStates) {
            setState(() {
              isLoading = true;
            });
          } else if (state is RawLandFailedStates) {
            setState(() {
              isLoading = false;
            });
          ...
          } else if (state is RawLandSuccessStates) {
            setState(() {
              isLoading = false;
            });
            showDialog(
                  ...
                  children: [
                    ...
                    if (isNationalIdSelected) ...[
                      ...
                      TextFormFieldCustom(
                        ...
                        onChanged: (value) {
                          // cooperativeModel.nationalIdNumber = value;
                        },
                      ),
                      SizedBox(height: constVerticalPadding),
                      ...
                      child: MainButton(
                        ...
                        onTap: () async {
                          ...
                          if (selectedCity != null &&
                            ...
                            print("error");
                            // showSnackBar(
                            //     context, "من فضلك اكمل المطلوب", Colors.red);
                          }
                        },
                      ),
                    ),
